...
{
    /*
        This class represents an AfterTaxMultiplicativeRelativeDiscountCalculator type. It is used to calculate the amount of Relative Discounts
        that have a Precendence (to be applied) after Tax and that are being applied Multiplicatively.

        To accomplish this, this class uses a List of all the Relative Discounts as well as a Filterer instance to find all the 
        Relative Discounts whose Precedence is after Tax and apply them to the Product provided Multiplicatively.
    ...
    */
    public class AfterTaxMultiplicativeRelativeDiscountCalculator : IRelativeDiscountCalculator
    {
        ...
        /*
            Class constructor initializes an AfterTaxMultiplicativeRelativeDiscountCalculator instance provided a 
            List of all the RelativeDiscounts applied to a ShoppingCart instance Multiplicatively.
        ...
        */
        public AfterTaxMultiplicativeRelativeDiscountCalculator(RelativeDiscountList relativeDiscountList)
        {
